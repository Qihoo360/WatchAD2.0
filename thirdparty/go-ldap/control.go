...
const (
	...
	// ControlTypeMicrosoftSDFlags - https://docs.microsoft.com/zh-cn/previous-versions/windows/desktop/ldap/ldap-server-sd-flags-oid
...
type ControlMicrosoftSDFlagsOID struct {
	Flags uint32
}

// GetControlType returns the OID
func (c *ControlMicrosoftSDFlagsOID) GetControlType() string {
	return ControlTypeMicrosoftSDFlags
}

// Encode returns the ber packet representation
func (c *ControlMicrosoftSDFlagsOID) Encode() *ber.Packet {
	packet := ber.Encode(ber.ClassUniversal, ber.TypeConstructed, ber.TagSequence, nil, "Control")
	packet.AppendChild(ber.NewString(ber.ClassUniversal, ber.TypePrimitive, ber.TagOctetString, ControlTypeMicrosoftSDFlags, "Control Type (LDAP_SERVER_SD_FLAGS_OID)"))
...
// String returns a human-readable description
func (c *ControlMicrosoftSDFlagsOID) String() string {
	return fmt.Sprintf(
		"Control Type: %s (%q)",
